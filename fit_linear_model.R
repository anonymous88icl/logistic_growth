...
#We assume the three programs are run in series -- no need to re-read the data file
...
#   regression directly by minimizing squared loss, but of course that would require
